    ...
    "configurations": [
        {
            ...
            "defines": [],
            # "compilerPath": "/opt/xkvm-native-buildkit/bin/arm-rockchip830-linux-uclibcgnueabihf-gcc",
            "cStandard": "c17",
            "cppStandard": "gnu++17",
...
def configure_c_intellisense():
    ...
    settings['configurations'][0]['compilerPath'] = "/opt/xkvm-native-buildkit/bin/arm-rockchip830-linux-uclibcgnueabihf-gcc"
